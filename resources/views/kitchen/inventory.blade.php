                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown" id="filterLogic">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" data-value="expiring" href="#">Expiring Soon</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr class="searchable-item filterable-item" data-status="low stock">
                                    <td>Rice</td>
                                    <td>Grains</td>
                                    <td>50</td>
                                    <td>kg</td>
                                ...
                                <tr class="searchable-item filterable-item" data-status="in stock">
                                    <td>Chicken</td>
                                    <td>Meat</td>
                                    <td>100</td>
                                    <td>kg</td>
                                ...
                                <tr class="searchable-item filterable-item" data-status="expiring soon">
                                    <td>Milk</td>
                                    <td>Dairy</td>
                                    <td>20</td>
                                    <td>liters</td>
